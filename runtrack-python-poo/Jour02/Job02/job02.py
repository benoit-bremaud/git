...
class Professeur(Personne): # Définit en classe fille de la classe 'Personne'
    """Classe définissant 'Professeur' caractérisée par attributs :
    - matiereEnseignée : attribut privé
    """
    def matiereEnseignée(self, matiereenseignée):
        """Méthode qui renvoi la matière enseignée du prof
        """
        return matiereenseignée
